...
public class Lab1 {
	public static void main(String[] args) {
		...
		//write a funtion thhat computes factorial "hint : use recursion, n = n *(n-1)! = n*(n-1)*(n-2)! = n*(n-1)*(-2)*(n-3)....
		System.out.println("Factorial:" + fact(5));
		
		//Write two functions that return the min avg, and max of an array
